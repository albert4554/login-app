...
/*
    ...
    public ResponseEntity<Map<String, String>> handleAccessDenied(AccessDeniedException ex) {
        Map<String, String> response = Map.of("error", "Access denied");
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(response);
    }

    @ExceptionHandler(AuthenticationException.class)
    public ResponseEntity<Map<String, String>> handleAuthentication(AuthenticationException ex) {
        Map<String, String> response = Map.of("error", "Authentication failed");
 ...
 */
    ...
    public ResponseEntity<ApiErrorDto> handlerGeneralExceptions(Exception exception,
        ...
        System.out.println("Ejecutando excepciones ------");
        exception.printStackTrace();
        if(exception instanceof HttpClientErrorException) {
            return this.handleHttpClientErrorException((HttpClientErrorException) exception, request, webRequest);
        }else if( exception instanceof  AuthenticationException){
            return this.handleAuthenticationException((AuthenticationException) exception,request);
        }else if(exception instanceof java.nio.file.AccessDeniedException){
            return this.handleAccessDeniedException((java.nio.file.AccessDeniedException) exception, request, webRequest);
    ...
    @ExceptionHandler(AuthenticationException.class)
    public ResponseEntity<ApiErrorDto> handleAuthenticationException(AuthenticationException exception,HttpServletRequest request) {
        ApiErrorDto dto = new ApiErrorDto(
    ...
    public ResponseEntity<?> handleAuthError(AuthenticationCredentialsNotFoundException ex) {
